...
public class SagaOrchestratorApplication {
    ...
    public static void main(String[] args) {
        ...
        //dispatchSingleServices(commandBus, orderId, stockId);
        sendSagaServices(commandGateway, orderId, stockId);
    }

    /*
    private static void dispatchSingleServices(CommandBus commandBus, String orderId, String stockId) {
    ...
    */
    ...
    private static void sendSagaServices(CommandGateway commandGateway, String orderId, String articleId) {
