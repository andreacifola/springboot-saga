...
class StockUpdateCommand(@TargetAggregateIdentifier val articleId: String, val article: String, val stockId: String, val quantity: Int)
class StockUpdatedEvent(val articleId: String, val article: String, val stockId: String, val quantity: Int)

class AbortStockCommand(@TargetAggregateIdentifier val articleId: String, val article: String, val stockId: String, val quantity: Int)
...
class StockSagaEndedEvent(val articleId: String, val article: String, val stockId: String, val quantity: Int)

class TriggerCompensatePaymentCommand(@TargetAggregateIdentifier val articleId: String, val article: String, val stockId: String, val quantity: Int)
