...
class StockUpdatedEvent(val stockId: String, val articleId: String, val article: String, val quantity: Int)
...
class StockSagaEndedEvent(val stockId: String, val articleId: String, val article: String, val quantity: Int)
