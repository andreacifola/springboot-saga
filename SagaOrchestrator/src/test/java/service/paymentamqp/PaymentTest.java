...
public class PaymentTest {
    ...
    public void testDoPayment() throws Exception {
        fixture.givenNoPriorActivity()
                .when(new TriggerPaymentCommand("1sd3gg54", "Alice", "5555", "30$"))
                .expectEvents(new PaymentTriggeredEvent("1sd3gg54", "Alice", "5555", "30$"));
    }
    ...
    */
    ...
    public void testWrongPayment() throws Exception {
        fixture.givenNoPriorActivity()
                .when(new TriggerPaymentCommand("1sd3gg54", "Alice", "5555", "630$"))
                .expectNoEvents()
    ...
    public void testRefundPayment() throws Exception {
        fixture.given(new PaymentTriggeredEvent("1sd3gg54", "Alice", "5555", "30$"))
                .when(new TriggerCompensateOrderCommand("1sd3gg54", "Alice", "5555", "30$"))
                .expectEvents(new OrderCompensateTriggeredEvent("1sd3gg54", "Alice", "5555", "30$"));
    }
